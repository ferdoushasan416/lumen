<?php
/**
 * Lumen functions and definitions
 *
...
function lumen_setup() {
	/*
		...
		* If you're building a theme based on Lumen, use a find and replace
		* to change 'lumen' to the name of your theme in all the template files.
		*/
 ...
 */
function lumen_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'lumen_content_width', 640 );
}
add_action( 'after_setup_theme', 'lumen_content_width', 0 );
